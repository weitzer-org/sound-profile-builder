...
test('QC-2 HTMX Dashboard Loads and Handles Constraints', async ({ page }) => {
  ...
  // Modify Physical constraints and select guitars
  await page.locator('select[name="guitar"]').selectOption('Fender Stratocaster Single Coil');
  await page.locator('input[name="constraint_mode"]').uncheck();
