...
func (m *mockOrchestratorSuccessComplex) RunPipeline(ctx context.Context, prompt string, constraints map[string]interface{}, onProgress func(string)) (string, *agents.TokenUsage, error) {
