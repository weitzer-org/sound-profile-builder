...
// GoldenQueryOrder is the canonical, stable ordering of the golden-set query names, used
// wherever a tool needs to iterate deterministically (report tables, sequential live runs).
var GoldenQueryOrder = []string{
...
// GoldenQueries maps each golden-set query name to its user-facing prompt text.
