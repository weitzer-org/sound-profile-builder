...
<!-- TODO: 1) A short explanation within each effect on why it was selected. We will need to update the HTML table schema above to accommodate a new column or description row for this payload. -->
