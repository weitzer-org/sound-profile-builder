...
// fine, a confusing asymmetry. Exported so cmd/critic_probe can mirror the exact same
// fence-stripping the live pipeline does before unmarshaling the critic's response.
